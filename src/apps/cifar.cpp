/*
 * cifar.cpp: Sparse DNN inference for CIFAT-10 (10 classes)/CIFAR-100 (100 classes) datasets
 * [https://www.cs.toronto.edu/~kriz/cifar.html]
 * (c) Mohammad Hasanzadeh Mofrad, 2020
 * (e) m.hasanzadeh.mofrad@gmail.com
 */
 
// make clean && make && time mpirun.mpich -np 2 bin/./cifar -i 50000 1024 10 /zfs1/cs3580_2017F/moh18/dnn/cifar10/bin/ -n 2048 120 /zfs1/cs3580_2017F/moh18/dnn/cifar10/bin/ -c 1 1 -p 0 -h 3 # CIFAR-10
...
int main(int argc, char **argv) {
    ...
    uint32_t ci, cl, p, h;
    Env::read_options(argc, argv, "CIFAR", "Customized DNN", 
