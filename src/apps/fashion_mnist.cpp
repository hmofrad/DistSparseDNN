/*
 * fashion_mnist.cpp: Sparse DNN inference for Fashion MNIST dataset
 * [https://github.com/zalandoresearch/fashion-mnist]
 * (c) Mohammad Hasanzadeh Mofrad, 2020
 * (e) m.hasanzadeh.mofrad@gmail.com
 */
 
// make clean && make && time mpirun.mpich -np 1 bin/./fashion_mnist -m 60000 784 -n 2048 -l 30 -c 10 data/fashion_mnist/bin/ data/fashion_mnist/bin/ -p 0
